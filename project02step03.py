...
class new_emp():
    ...
    def test(self):
        ...
        xpath_for_first_name = '/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div[2]/div[1]/div[1]/div/div/div[2]/div[1]/div[2]/input'
        first_name = driver.find_element(By.XPATH, xpath_for_first_name)
        # Sending keys for first name
        first_name.send_keys("VISHAL")
        time.sleep(3)
       ...
       # Sending keys for last name
        ...
        username_input.send_keys("Vishal JAIN")
        time.sleep(3)
        # Enabling status
